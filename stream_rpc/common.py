...
class Protocol(ABC):
    ...
    def __init__(
        self, peer_id, reader, writer, message_separator=STREAM_RPC_TERM,
    ):
        """Initialize class.
    ...
    def create_message_packet(self, *args, **kwargs):
        """Create message packet using helpful function above."""
    ...
    async def send_message(self, message_packet):
        ...
        processed in self.process_payload(), so after every sending
    ...
    async def read_message(self):
        ...
        self.process_payload(), define there all you needed.
